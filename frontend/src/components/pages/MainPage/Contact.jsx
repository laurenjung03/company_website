  ...
  return (
    <div className="bg-white py-12 ">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="mb-12 max-4xl mx-auto">
        ...
        <div className="mt-12 text-center">
          <Link
            to="/contact"
            className="inline-block px-10 py-5 text-lg text-white bg-blue-600 rounded-lg shadow hover:bg-blue-700 transition-all duration-300 hover:shadow-lg"
          >
            문의하기
          </Link>
        </div>
